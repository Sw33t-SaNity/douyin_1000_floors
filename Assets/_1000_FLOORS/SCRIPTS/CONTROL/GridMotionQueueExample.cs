...
namespace YF_3DGameBase.Examples
{
    ...
    /// 4. Create UnifiedGiftAction assets:
    ///    - Right-click > Create > Douyin Live > Interaction Actions > Gift > Unified Gift Action
    ///    - Assign your GiftActionData
    /// 5. Add UnifiedGiftAction to LiveInteractionConfig's gift mappings
    ///    - NOTE: All gifts use the same UnifiedGiftAction type - only the GiftActionData differs
    /// 
    /// HOW IT WORKS:
